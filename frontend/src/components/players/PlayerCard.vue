<script setup>
  ...
  const handleImageError = (event) => { event.target.src = placeholderImg; };

  // funzione per navigare alla pagina di dettaglio del giocatore
  const goToDetail = () => { router.push(`/player/${props.player.playerId}`); };
</script>
