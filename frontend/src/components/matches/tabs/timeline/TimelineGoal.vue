...
<template>
  <div class="timeline-card goal-card-light" v-if="scorer">
      ...
      <div class="card-body-inner">
        <div class="player-details">
          ...
          <div class="team-info">
            ...
            <span class="team-details">{{ team.nome }} · {{ scorer.ruolo }}</span>
          </div>
