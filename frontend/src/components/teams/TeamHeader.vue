...
<style scoped>
  ...
  @media (max-width: 1024px) {
    .team-header { 
      padding: 40px 5%; 
      min-height: auto; 
      align-items: center; /* Centra il contenuto verticalmente nel banner */
    }
    ...
    .text-info { margin-left: 0; }

    .text-info h1 { 
      font-size: 2.5rem; 
    }

    /* CENTRATURA ICONE SOCIAL */
    .social-icons { 
      justify-content: center; /* Centra le icone rispetto al testo */
      margin-top: 15px; 
    }
  ...
  @media (max-width: 480px) {
    .text-info h1 { font-size: 2rem; }
    .stat-line strong { font-size: 1.1rem; }
    .btn-website { padding: 10px 20px; font-size: 0.8rem; }
  }
</style>