<script setup>
  ...
  onMounted(async () => {
    // Recupero classifica e squadre in parallelo
    const [standingsData, teamsData] = await Promise.all([
      getStandings(),
      getTeams()
    ])

    // Associo il logo e il nome corretto della squadra ad ogni riga della classifica
  ...
  <section class="home-standings">
    <div class="standings-card">
      ...
      <div class="table-dark-bg">
        <!-- Mostro solo le prime 5 posizioni nella home -->
