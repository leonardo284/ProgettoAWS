<script setup>
  ...
  const teams = ref([])
  const scrollContainer = ref(null)  // Riferimento al contenitore scrollabile (compoenntente del DOM)
  ...
  // Funzione per scrollare il contenitore
...
<style scoped>
  ...
  @media (max-width: 768px) {
    ...
    .nav-btn { display: none; } /* Nasconde frecce su mobile */
  }
</style>